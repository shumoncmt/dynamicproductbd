...
<head>
    ...
    <title>GKS Series Centrifugal pump in Bangladesh - Best industrial electric motor in Bangladesh | Dynamic GKS Series
        Centrifugal</title>
    <meta name="description"
        content="GKS Series Centrifugal Pump in Bangladesh, designed for efficiency and reliability in various applications." />
    <meta name="keywords"
        content="GKS Series Centrifugal Pump in Bangladesh, offering superior performance and durability for all your pumping needs.">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 service-info " style="margin-top:15px;">
                    <div class="item"><a href={{Route('industrialpump')}} class="post-image view image_hover"> <img
                                src="{{ asset('img/catagory/pump/gks-series-centrifugal-pump.jpg')}}" alt=""
                ...
                <div class="col-md-6 col-sm-8" style="margin-top: 15px; margin-left:15px">
                    ...
                    <button type="button" class="btn btn-outline-success" style="margin:4px;"> <a href="#">Inquire Now
                            ...
                            href="https://greengenesisbd.com/wp-content/uploads/2022/08/GKS-Series-Centrifugal-Pump.pdf">
                            Brochure</a></button>
