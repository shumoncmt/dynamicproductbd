...
Route::get('/product/dynamic-submersible-pump-3″stm1', [SiteController::class, 'dynamicsubmersiblepump3stm1'])->name('dynamicsubmersiblepump3stm1');
Route::get('/product/dynamic-submersible-pump-3″stm2', [SiteController::class, 'dynamicsubmersiblepump3stm2'])->name('dynamicsubmersiblepump3stm2');
Route::get('/product/dynamic-submersible-pump-3″stm3.5', [SiteController::class, 'dynamicsubmersiblepump3stm35'])->name('dynamicsubmersiblepump3stm35');
...
Route::get('/product/dynamic-submersible-pump-4″stm2', [SiteController::class, 'dynamicsubmersiblepump4stm2'])->name('dynamicsubmersiblepump4stm2');
Route::get('/product/dynamic-submersible-pump-4″stm3', [SiteController::class, 'dynamicsubmersiblepump4stm3'])->name('dynamicsubmersiblepump4stm3');
Route::get('/product/dynamic-submersible-pump-4″stm4', [SiteController::class, 'dynamicsubmersiblepump4stm4'])->name('dynamicsubmersiblepump4stm4');
Route::get('/product/dynamic-submersible-pump-4″stm6', [SiteController::class, 'dynamicsubmersiblepump4stm6'])->name('dynamicsubmersiblepump4stm6');
Route::get('/product/dynamic-submersible-pump-4″stm8', [SiteController::class, 'dynamicsubmersiblepump4stm8'])->name('dynamicsubmersiblepump4stm8');
Route::get('/product/dynamic-submersible-pump-4″stm10', [SiteController::class, 'dynamicsubmersiblepump4stm10'])->name('dynamicsubmersiblepump4stm10');
Route::get('/product/dynamic-submersible-pump-4″stm12', [SiteController::class, 'dynamicsubmersiblepump4stm12'])->name('dynamicsubmersiblepump4stm12');
Route::get('/product/dynamic-submersible-pump-4″stm16', [SiteController::class, 'dynamicsubmersiblepump4stm16'])->name('dynamicsubmersiblepump4stm16');
